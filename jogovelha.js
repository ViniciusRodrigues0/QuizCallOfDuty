...
if(vez==1){
document.getElementById("img"+casa).src="imagens/cogumelo-removebg-preview.png"; //se o jogador for -1, coloca o desenho da bola
}else{
document.getElementById("img"+casa).src="imagens/coin-removebg-preview.png";
} 
